...
/**
 * Calls the structured parse API for the Smart Inbox
 * @param {string|Array} content - Raw text or multimodal array for Claude
 */
export async function parseSmartInboxData(content) {
